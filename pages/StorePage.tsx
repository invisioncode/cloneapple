        ...
        <div className="max-w-[1440px] mx-auto">
            ...
            <section className="pt-20 pb-12 px-6 md:px-12 flex flex-col md:flex-row justify-between items-start md:items-end">
                ...
                <div className="flex items-center gap-3 mt-4 md:mt-0">
                    <div className="flex flex-col items-end">
                        ...
                        <a href="/store/chat" className="text-[14px] text-[#0066cc] hover:underline">Hỏi Chuyên Gia</a>
                    </div>
            ...
            <section className="overflow-x-auto no-scrollbar pb-16 px-6 md:px-12">
                <div className="flex gap-8 min-w-max">
                    {storeNav.map((item) => (
                        <a key={item.name} href={`/shop/${item.name.toLowerCase().replace(/ /g, '-')}`} className="group flex flex-col items-center gap-3 min-w-[120px]">
            ...
            <section className="pb-24 px-6 md:px-12 max-w-[1440px] mx-auto">
                ...
                <div className="flex flex-wrap gap-3">
                    {['Trạng Thái Đơn Hàng', 'Trợ Giúp Mua Hàng', 'Trả hàng', 'Mục Đã Lưu', 'Vận Chuyển & Giao Hàng', 'Thanh toán'].map(link => (
                        <a key={link} href={`/store/${link.toLowerCase().replace(/ /g, '-')}`} className="px-4 py-2 bg-[#e8e8ed] hover:bg-[#d2d2d7] rounded-full text-[14px] font-medium text-[#1d1d1f] transition-colors">
                            {link}
                        </a>
                    ))}
                </div>
